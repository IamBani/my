    ...
    <div class="hyglPanelClass">
      <div class="hygl-padding">
        ...
        <div class="hygl-top-conten">
          <el-row :gutter="20">
            <el-col :span="24">
              <el-button @click="xzygflClick('新增员工分类')">新增员工分类</el-button>
            </el-col>
          </el-row>
        </div>
        <!-- 列表 -->
            ...
            >
              <el-table-column width="350" label="操作">
                <template slot-scope="scope">
                  ...
                  <label class="table-btn" @click="xzygflClick('编辑员工管理',scope.row)">编辑</label>
...
import xzygflDialog from './xzygflDialog'
