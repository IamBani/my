<template>
  <div class="container">
      ...
      <div class="hygl-padding">
        ...
        <div class="hygl-top-conten">
          <el-row :gutter="20">
            ...
            <el-col :span="14">
              <el-button @click="xzyhglClick('新增商品')">新增商品</el-button>
            </el-col>
          </el-row>
        </div>
        <!-- 列表 -->
    ...
    <shopAddress v-model="visible" />
  </div>
</template>
<script>
import tableContainer from "../../../components/common/tableView";
import pageCommon from "../../../components/common/pageCommon";
import xzyhglDialog from "../xtgl/xtglZJ/xzyhglDialog";
import shopAddress from './spglZJ/sptcView/shopAddress.vue';
