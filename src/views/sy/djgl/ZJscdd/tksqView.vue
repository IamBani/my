  ...
  <div class="container">
    <div class="djglPanelClass">
      ...
      <div class="mxmxsj-top">
        ...
        <el-row class="top">
          <el-col :span="24">
            <el-input v-model="input" placeholder="单据号" style=" width:120px;margin-right: 15px;"></el-input>
            <el-select v-model="value" placeholder="待退款" style=" width:150px;margin-right: 15px;">
              <el-option
