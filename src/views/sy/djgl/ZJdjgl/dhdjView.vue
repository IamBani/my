      ...
      <div class="mxmxsj-top">
        ...
        <el-row class="top">
          <el-col :span="24">
            ...
            <el-input v-model="input" placeholder="请输入单据" style=" width:120px;margin-right: 15px;"></el-input>
            <el-input v-model="input" placeholder="请输入会员卡号/手机号/姓名" style=" width:120px;margin-right: 15px;"></el-input>
            <el-input v-model="input" placeholder="实付积分" style=" width:120px;margin-right: 15px;"></el-input>
            <el-input v-model="input" placeholder="实付积分" style=" width:120px;margin-right: 15px;"></el-input>
